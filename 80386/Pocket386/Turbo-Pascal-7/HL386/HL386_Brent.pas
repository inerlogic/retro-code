...
{ FindMu: Brent's phase 1 (CycleCandidate, above) only finds a candidate
  ...
  on checkpoint-schedule luck, not on the pattern itself. This function
  ...
  for the next seed regardless of what this leaves behind in it. }
...
begin
  ...
  SeedGrid;
  CopyGrid(CellA, CellB);   { hare starts at x0 too, for now }
